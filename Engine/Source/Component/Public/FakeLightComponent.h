...
UCLASS()
class UFakeLightComponent : public USceneComponent
{
    GENERATED_BODY()
    DECLARE_CLASS(UFakeLightComponent, USceneComponent)

public:
    UFakeLightComponent() = default;

    virtual ~UFakeLightComponent() = default;
