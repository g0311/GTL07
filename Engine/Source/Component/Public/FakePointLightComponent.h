...
UCLASS()
class UFakePointLightComponent : public UFakeLightComponent
{
    GENERATED_BODY()
    DECLARE_CLASS(UFakePointLightComponent, UFakeLightComponent)

public:
    UFakePointLightComponent() = default;

    virtual ~UFakePointLightComponent() = default;
